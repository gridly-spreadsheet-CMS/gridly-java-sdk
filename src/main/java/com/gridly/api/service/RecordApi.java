...
public class RecordApi {
    ...
    private okhttp3.Call fetchValidateBeforeCall(String viewId, List<String> columnIds, String page, String query, String sort, FetchFileOption fetchFileOption, String afterRecordId, String beforeRecordId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = fetchCall(viewId, columnIds, page, query, sort, fetchFileOption, afterRecordId, beforeRecordId, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call fetchHistoriesCall(String viewId, String recordId, String page, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fetchHistoriesValidateBeforeCall(String viewId, String recordId, String page, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = fetchHistoriesCall(viewId, recordId, page, _callback);
        return localVarCall;
     ...
     */
    public List<RecordHistory> fetchHistories(String viewId, String recordId, String page) throws ApiException {
        ApiResponse<List<RecordHistory>> localVarResp = fetchHistoriesWithHttpInfo(viewId, recordId, page);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<RecordHistory>> fetchHistoriesWithHttpInfo(String viewId, String recordId, String page) throws ApiException {
        okhttp3.Call localVarCall = fetchHistoriesValidateBeforeCall(viewId, recordId, page, null);
     ...
     */
    public okhttp3.Call fetchHistoriesAsync(String viewId, String recordId, String page, final ApiCallback<List<RecordHistory>> _callback) throws ApiException {

        okhttp3.Call localVarCall = fetchHistoriesValidateBeforeCall(viewId, recordId, page, _callback);
        Type localVarReturnType = new TypeToken<List<RecordHistory>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
