...
public class RecordApi {
     ...
     * @param fetchFileOption fetchFileOption (optional, default to id)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call fetchCall(String viewId, List<String> columnIds, String page, String query, String sort, FetchFileOption fetchFileOption, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call fetchValidateBeforeCall(String viewId, List<String> columnIds, String page, String query, String sort, FetchFileOption fetchFileOption, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = fetchCall(viewId, columnIds, page, query, sort, fetchFileOption, _callback);
        return localVarCall;
     ...
     */
    public List<Record> fetch(String viewId, List<String> columnIds, String page, String query, String sort, FetchFileOption fetchFileOption) throws ApiException {
        ApiResponse<List<Record>> localVarResp = fetchWithHttpInfo(viewId, columnIds, page, query, sort, fetchFileOption);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Record>> fetchWithHttpInfo(String viewId, List<String> columnIds, String page, String query, String sort, FetchFileOption fetchFileOption) throws ApiException {
        okhttp3.Call localVarCall = fetchValidateBeforeCall(viewId, columnIds, page, query, sort, fetchFileOption, null);
        Type localVarReturnType = new TypeToken<List<Record>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call fetchAsync(String viewId, List<String> columnIds, String page, String query, String sort, FetchFileOption fetchFileOption, final ApiCallback<List<Record>> _callback) throws ApiException {

        okhttp3.Call localVarCall = fetchValidateBeforeCall(viewId, columnIds, page, query, sort, fetchFileOption, _callback);
        Type localVarReturnType = new TypeToken<List<Record>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call updateValidateBeforeCall(String viewId, List<SetRecord> setRecord, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateCall(viewId, setRecord, _callback);
        return localVarCall;
    ...
    private okhttp3.Call updateRecordValidateBeforeCall(String id, String viewId, SetRecord setRecord, String path, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateRecordCall(id, viewId, setRecord, path, _callback);
        return localVarCall;
