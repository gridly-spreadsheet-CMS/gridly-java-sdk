...
public class DatabaseApi {
     ...
     */
    public okhttp3.Call listCall(List<String> expand, String page, Long projectId, String search, String sort, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(List<String> expand, String page, Long projectId, String search, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listCall(expand, page, projectId, search, sort, _callback);
        return localVarCall;
     ...
     */
    public List<Database> list(List<String> expand, String page, Long projectId, String search, String sort) throws ApiException {
        ApiResponse<List<Database>> localVarResp = listWithHttpInfo(expand, page, projectId, search, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Database>> listWithHttpInfo(List<String> expand, String page, Long projectId, String search, String sort) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(expand, page, projectId, search, sort, null);
     ...
     */
    public okhttp3.Call listAsync(List<String> expand, String page, Long projectId, String search, String sort, final ApiCallback<List<Database>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(expand, page, projectId, search, sort, _callback);
        Type localVarReturnType = new TypeToken<List<Database>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
