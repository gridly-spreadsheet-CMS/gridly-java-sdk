...
public class ViewFileApi {
     ...
     */
    public okhttp3.Call uploadCall(String viewId, String columnId, File file, String recordId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call uploadValidateBeforeCall(String viewId, String columnId, File file, String recordId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public UploadedFile upload(String viewId, String columnId, File file, String recordId) throws ApiException {
     ...
     */
    public ApiResponse<UploadedFile> uploadWithHttpInfo(String viewId, String columnId, File file, String recordId) throws ApiException {
     ...
     */
    public okhttp3.Call uploadAsync(String viewId, String columnId, File file, String recordId, final ApiCallback<UploadedFile> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call uploadZipCall(String viewId, String columnId, File file, String fileMappings, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call uploadZipValidateBeforeCall(String viewId, String columnId, File file, String fileMappings, final ApiCallback _callback) throws ApiException {
     ...
     */
    public List<Record> uploadZip(String viewId, String columnId, File file, String fileMappings) throws ApiException {
     ...
     */
    public ApiResponse<List<Record>> uploadZipWithHttpInfo(String viewId, String columnId, File file, String fileMappings) throws ApiException {
     ...
     */
    public okhttp3.Call uploadZipAsync(String viewId, String columnId, File file, String fileMappings, final ApiCallback<List<Record>> _callback) throws ApiException {
