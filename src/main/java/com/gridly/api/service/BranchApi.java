...
public class BranchApi {
    ...
    private okhttp3.Call callListValidateBeforeCall(String gridId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = callListCall(gridId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call createValidateBeforeCall(CreateBranch createBranch, String gridId, String branchId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createCall(createBranch, gridId, branchId, _callback);
        return localVarCall;
     ...
     */
    public Task merge(String branchId, String destinationBranchId, List<String> mergeRecordOptions) throws ApiException {
        ApiResponse<Task> localVarResp = mergeWithHttpInfo(branchId, destinationBranchId, mergeRecordOptions);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Task> mergeWithHttpInfo(String branchId, String destinationBranchId, List<String> mergeRecordOptions) throws ApiException {
     ...
     */
    public okhttp3.Call mergeAsync(String branchId, String destinationBranchId, List<String> mergeRecordOptions, final ApiCallback<Task> _callback) throws ApiException {
