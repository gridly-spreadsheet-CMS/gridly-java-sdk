...
public class ProjectDetail implements Serializable {
  ...
  **/
  ...
  public ProjectDetail companyId(Long companyId) {
  ...
  **/
  ...
  public ProjectDetail type(TypeEnum type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, projectDetail.id) &&
        Objects.equals(this.companyId, projectDetail.companyId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, companyId, name, description, type, databases, groups);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
