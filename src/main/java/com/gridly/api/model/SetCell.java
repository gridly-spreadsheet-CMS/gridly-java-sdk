...
public class SetCell implements Serializable {
  ...
  **/
  ...
  public SetCell lengthLimit(Integer lengthLimit) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columnId, setCell.columnId) &&
        ...
        Objects.equals(this.lengthLimit, setCell.lengthLimit) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(columnId, dependencyStatus, lengthLimit, referencedIds, sourceStatus, value);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SetCell.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
