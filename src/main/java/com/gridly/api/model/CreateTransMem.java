...
public class CreateTransMem implements Serializable {
  ...
  **/
  ...
  public CreateTransMem allowAlternative(Boolean allowAlternative) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createTransMem.name) &&
        ...
        Objects.equals(this.allowAlternative, createTransMem.allowAlternative);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, projectIds, fuzzyMatch, isDisabled, isPausedConsuming, contextLookup, populateTranslationStatus, allowAlternative);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateTransMem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
