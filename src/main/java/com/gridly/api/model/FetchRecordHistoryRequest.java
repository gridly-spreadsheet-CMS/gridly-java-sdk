...
public class FetchRecordHistoryRequest implements Serializable {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FetchRecordHistoryRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("columnIds") != null && !jsonObj.get("columnIds").isJsonArray()) {
