...
public class MovePath implements Serializable {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.names, movePath.names) &&
        Objects.equals(this.fromParentPath, movePath.fromParentPath) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(names, fromParentPath, toParentPath, moveBefore, moveAfter);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MovePath.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
